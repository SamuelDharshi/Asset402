...
const roles = ["real-world assets", "gasless agreements", "micropayment streams", "defi collateral", "carbon credits"]
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 lg:items-center lg:min-h-[70vh]">
          ...
          <div className="space-y-8 sm:space-y-10">
            ...
            <p className="max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground animate-fade-in-up stagger-2">
              Autonomous Real-World Asset (RWA) monetization protocol on the Casper Network. 
              Connect industrial equipment, generate on-chain yield, and stream micropayments split 
              with DeFi liquidity providers and carbon offset systems.
            </p>
