...
const navItems = [
  ...
  { label: "Carbon CUC", href: "/carbon" },
  { label: "Maintenance", href: "/maintenance" },
]

const socialLinks = [
  { label: "GitHub", href: "https://github.com/casper-network", icon: Github },
  { label: "Twitter", href: "https://twitter.com/Casper_Network", icon: Twitter },
  { label: "LinkedIn", href: "https://linkedin.com/company/casper-association", icon: Linkedin },
]
          ...
          <div className="hidden items-center gap-1 md:flex">
            ...
            <div className="ml-2 flex items-center gap-2">
              ...
              {isConnected ? (
                <button
                  onClick={disconnect}
                  className="rounded-lg border border-primary/50 bg-primary/10 px-4 py-2 font-mono text-xs text-primary transition-all duration-300 hover:bg-primary hover:text-primary-foreground"
                >
