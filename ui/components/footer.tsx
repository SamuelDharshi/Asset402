...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/casper-network", handle: "@casper-network", icon: Github },
  { label: "Twitter", href: "https://twitter.com/Casper_Network", handle: "@Casper_Network", icon: Twitter },
  { label: "LinkedIn", href: "https://linkedin.com/company/casper-association", handle: "/casper-association", icon: Linkedin },
  { label: "Email", href: "mailto:info@casper.network", handle: "info@casper.network", icon: Mail },
]
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-12 sm:gap-16 lg:grid-cols-2">
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-in-up">
            <div className="space-y-3">
              <p className="font-mono text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-primary">Casper RWA</p>
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl text-balance">
                {"Decentralized Real-World Assets "}
                <span className="bg-gradient-to-l from-primary/50 to-accent text-transparent bg-clip-text ">Protocol</span>
              </h2>
            </div>
            <p className="max-w-md text-base sm:text-lg text-muted-foreground leading-relaxed">
              Providing gasless scheduling, dynamic yield streaming, and audited proof-of-state for physical infrastructure.
            </p>

            <div className="pt-2">
              <a
                href="mailto:info@casper.network"
        ...
        <div className="mt-16 sm:mt-20 flex flex-col items-center justify-between gap-6 border-t border-border/30 pt-8 sm:pt-10 sm:flex-row animate-fade-in stagger-4">
          <div className="flex items-center gap-2.5 font-mono text-xs text-muted-foreground">
            ...
            <span>Secured by Casper Smart Contracts</span>
          </div>
          ...
          <p className="font-mono text-xs text-muted-foreground text-center sm:text-right">
            © {new Date().getFullYear()} Asset402 — All rights reserved
          </p>
        </div>
      </div>
    </footer>
